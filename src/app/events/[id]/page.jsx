  ...
  return (
    <div className="text-kurator-primary mt-2 md:mt-10 ">
      ...
      <div className="text-left text-kurator-primary px-6 md:px-16 py-2 md:py-16 space-y-5 mt-10 md:mt-0">
        ...
        <p className="text-md-fluid max-w-screen-md italic md:mt-10 mt-2 md:mb-6 mb-4">{event.description}</p>
        ...
        <h2 className="text-2xl-fluid font-bold text-kurator-primary mb-4">Værker:</h2>
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {artworks.map((art) => (
            <div key={art.id} className="transition-transform duration-300 hover:scale-105">
        ...
        <div className="border-t pt-8 pb-8 px-6">
          <p className="text-md-fluid font-semibold mb-4">Pris: 200 kr pr. billet</p>
